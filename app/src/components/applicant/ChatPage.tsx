      ...
      <div className="bg-white p-4 border-t">
        <div className="flex items-center">
          <textarea
            ...
            className="flex-1 border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-500 resize-none"
            rows={1}
          />
          <button
            onClick={handleSendMessage}
            disabled={newMessage.trim() === ''}
            className="ml-2 bg-yellow-500 text-black rounded-full p-2 hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed"
          >
